...
|---|---|---|---|
| `input_pin` | pin | обязательный | Пин, который перехватываем. Настраивается как вход с внутренним pull-up и прерыванием по любому фронту. |
...
Подробнее о подключении нескольких модулей из одного репозитория — в
